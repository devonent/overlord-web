	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="section-title text-center col-12 mb-3">
				<h1>Precios increíbles, instrumentos magníficos</h1>
				<p>Nosotros recopilamos algunas ofertas que podrían ser de tu interés</p>
			</div>
			<div class="col-10 text-center">
				<section class="lattest-product-area pb-5 category-list">
					<div class="row justify-content-center">
						...
						<div class="col-lg-3 col-md-5 shadow-sm p-2 m-2">
							<div class="single-product my-0">
								<img class="img-fluid" src="<?= base_url('public_resources/img/product/drums_default.jpg') ?>" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
						...
						<div class="col-lg-3 col-md-5 shadow-sm p-2 m-2">
							<div class="single-product my-0">
								<img class="img-fluid" src="<?= base_url('public_resources/img/product/keyboard_default.jpg') ?>" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
