                ...
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-01.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-01.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-02.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-02.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-03.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-03.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-04.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-04.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-05.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-05.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-06.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar004/guitar004-06.jpg') ?>" alt="">
                            </a>
                        </div>
                    </div>
                </div>
