                ...
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-01.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-01.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-02.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-02.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-03.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-03.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-04.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-04.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-05.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-05.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-06.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-06.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-07.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-07.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-08.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-08.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-09.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-09.jpg') ?>" alt="">
                            </a>
                        </div>
                        <div class="single-prd-item">
                            <a href="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-10.jpg') ?>" class="img-pop-up">
                                <img class="img-fluid" src="<?= base_url('public_resources/img/product/guitars/guitar001/guitar001-10.jpg') ?>" alt="">
                            </a>
                        </div>
                    </div>
                </div>
