            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="">
                        <div class="single-prd-item">
                            <a href="<?= base_url(INS_IMG_ROUTE . $keyboard->imagen) ?>" class="img-pop-up">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h1><strong><?= $keyboard->marca . ' ' . $keyboard->modelo ?></strong></h1>
                        <h3><?= $keyboard->acabado_color ?></h3>
                        <div class="mt-4 mb-3">
                            <h2 class="mb-0">$<?= $keyboard->precio ?></h2>
                            <!-- <h6 class="l-through">$37,499.99</h6> -->
                        </div>
                        <ul>
                            <!-- <li>Oferta válida hasta : 12/02/2022</li> -->
                            <li>Categoría : <a href="<?= base_url('/instrumentos/teclados') ?>" style="color: var(--secondary-color);">Teclados</a></li>
                            <li>Stock : <?= $keyboard->stock ?></li>
                        </ul>
                        <p class="mb-4">
                            <?= $keyboard->descripcion ?>
                        </p>
                        <div class="card_area d-flex align-items-center">
                            <a class="primary-btn" href="<?= base_url('instrumentos/teclados') ?>">Regresar</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- editable -->
                                        <h5><?= $keyboard->profundidad_mm . ' mm'?></h5>
                                    </td>
                                </tr>
