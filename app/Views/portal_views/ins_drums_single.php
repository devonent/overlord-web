            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="">
                        <div class="single-prd-item">
                            <a href="<?= base_url(INS_IMG_ROUTE . $drum->imagen) ?>" class="img-pop-up">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h1><strong><?= $drum->marca . ' ' . $drum->modelo ?></strong></h1>
                        <h3><?= $drum->acabado_color ?></h3>
                        <div class="mt-4 mb-3">
                            <h2 class="mb-0">$<?= $drum->precio ?></h2>
                            <!-- <h6 class="l-through">$37,499.99</h6> -->
                        </div>
                        <ul>
                            <!-- <li>Oferta válida hasta : 12/02/2022</li> -->
                            <li>Categoría : <a href="<?= base_url('/instrumentos/baterias') ?>" style="color: var(--secondary-color);">Baterías</a></li>
                            <li>Stock : <?= $drum->stock ?></li>
                        </ul>
                        <p class="mb-4">
                            <?= $drum->descripcion ?>
                        </p>
                        <div class="card_area d-flex align-items-center">
                            <a class="primary-btn" href="<?= base_url('instrumentos/baterias') ?>">Regresar</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <h5>Elementos extra</h5>
                                    </td>
                                    <td>
                                        <!-- editable -->
                                        <h5><?= $drum->elementos_extra ?></h5>
                                    </td>
                                </tr>
                                <!-- elemento -->
                                <tr>
