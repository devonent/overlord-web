            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="">
                        <div class="single-prd-item">
                            <a href="<?= base_url(INS_IMG_ROUTE . $monitor->imagen) ?>" class="img-pop-up">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h1><strong><?= $monitor->marca . ' ' . $monitor->modelo ?></strong></h1>
                        <h3><?= $monitor->acabado_color ?></h3>
                        <div class="mt-4 mb-3">
                            <h2 class="mb-0">$<?= $monitor->precio ?></h2>
                            <!-- <h6 class="l-through">$37,499.99</h6> -->
                        </div>
                        <ul>
                            <!-- <li>Oferta válida hasta : 12/02/2022</li> -->
                            <li>Categoría : <a href="<?= base_url('/instrumentos/monitores') ?>" style="color: var(--secondary-color);">Monitores</a></li>
                            <li>Stock : <?= $monitor->stock ?></li>
                        </ul>
                        <p class="mb-4">
                            <?= $monitor->descripcion ?>
                        </p>
                        <div class="card_area d-flex align-items-center">
                            <a class="primary-btn" href="<?= base_url('instrumentos/monitores') ?>">Regresar</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- editable -->
                                        <h5><?= $monitor->profundidad_mm . ' mm'?></h5>
                                    </td>
                                </tr>
