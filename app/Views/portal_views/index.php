				...
				<div class="col-lg-12 col-md-12 my-5 my-md-0">
					<div class="active-banner-slider owl-carousel my-5 my-md-0">
						...
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7 col-md-6 col-12">
								<div class="banner-img">
									<img class="img-fluid" src="<?= base_url('portal_resources/img/banner/guitar001-banner.png') ?>" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7 col-md-6 col-12">
								<div class="banner-img">
									<img class="img-fluid" src="<?= base_url('portal_resources/img/banner/guitar002-banner.png') ?>" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7 col-md-6 col-12">
								<div class="banner-img">
									<img class="img-fluid" src="<?= base_url('portal_resources/img/banner/guitar003-banner.png') ?>" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7 col-md-6 col-12">
								<div class="banner-img">
									<img class="img-fluid" src="<?= base_url('portal_resources/img/banner/guitar004-banner.png') ?>" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7 col-md-6 col-12">
								<div class="banner-img">
									<img class="img-fluid" src="<?= base_url('portal_resources/img/banner/guitar005-banner.png') ?>" alt="">
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<img class="img-fluid w-100" src="<?= base_url('portal_resources/img/category/guitar_c.jpg') ?>" alt="">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="<?= base_url('portal_resources/img/category/studio_c.jpg') ?>" alt="">
									<div class="deal-details">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="<?= base_url('portal_resources/img/category/keyboard_c.jpg') ?>" alt="">
									<div class="deal-details">
						...
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="<?= base_url('portal_resources/img/category/drum_c.jpg') ?>" alt="">
									<div class="deal-details">
