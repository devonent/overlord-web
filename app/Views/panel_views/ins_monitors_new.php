            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <?php
                        ...
                        echo form_open_multipart('panel/registrar_nuevo_monitor', $data);
                    ?>
                        <div class="form-body">
                            <div class="row">
                                <!-- Separador -->
                                ...
                                <div class="col-12 col-lg-4 text-center container-fluid">
                                    <div class="product-picture me-3">
                                        <img class="img-fluid" src="<?= base_url('img/products/m00.jpg') ?>" alt="imagen_producto" id="imagen-producto-previsualizacion">
                                    </div>
                                </div>
